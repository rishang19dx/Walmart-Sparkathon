...
export declare const AnchorCommitPresentation: import("codeco").SparseCodec<{
    cid: import("codeco").Type<import("multiformats").CID<unknown, number, number, import("multiformats").Version>, string, unknown>;
}>;
...
export declare const NotCompleteCASResponse: import("codeco").SparseCodec<{
    ...
    cid: import("codeco").Type<import("multiformats").CID<unknown, number, number, import("multiformats").Version>, string, string>;
