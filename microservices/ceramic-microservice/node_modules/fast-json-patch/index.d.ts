export * from 'fast-json-patch/module/core';
export * from 'fast-json-patch/module/duplex';
export {
    PatchError as JsonPatchError,
    _deepClone as deepClone,
    escapePathComponent,
    unescapePathComponent
} from 'fast-json-patch/module/helpers';


/**
 * Default export for backwards compat
 */
import * as core from 'fast-json-patch/module/core';
import * as duplex from 'fast-json-patch/module/duplex';
import { PatchError as JsonPatchError, _deepClone as deepClone, escapePathComponent, unescapePathComponent } from 'fast-json-patch/module/helpers';
